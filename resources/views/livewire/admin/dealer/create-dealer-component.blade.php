                ...
                <div class="card  box-shadow-0">
                    <div class="card-body">
                        <div class="form-group">
                            <x-form.input wire:model="name" :error="$errors->first('name')">Name</x-form.input>
                        </div>
                        <div class="form-group">
                            <x-form.input wire:model="email" :error="$errors->first('email')">Email</x-form.input>
                        </div>
                        <div class="form-group">
                            <x-form.input wire:model="phone" :error="$errors->first('phone')">Phone Number</x-form.input>
                        </div>
                        <div class="form-group">
